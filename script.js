...
const randomFloor = (max) => {
    return Math.floor(Math.random() * max) * 150 + 3;
}
...
// ----------------------------------------------------------------
const minDistancePerson1 = [parseInt(elevator1.style.bottom) - parseInt(person1.style.bottom),
...
const minDistancePerson2 = [parseInt(elevator1.style.bottom) - parseInt(person2.style.bottom),
...
const elevatorRunner = (floor) => {
    let minDistIndex1 = minDistancePerson1.indexOf(Math.min(...minDistancePerson1))
    let minDistIndex2 = minDistancePerson2.indexOf(Math.min(...minDistancePerson2))

    if(person1.style.bottom === `${150*(floor-1)+3}px`){
        elevatorArr[minDistIndex1].style.bottom = `${150*(floor-1)+3}px`
    ...
    }else if (person2.style.bottom === `${150*(floor-1)+3}px`){
        elevatorArr[minDistIndex2].style.bottom = `${150*(floor-1)+3}px`
